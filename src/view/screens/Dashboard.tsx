...
import { setQuery } from "../../redux/slice/dashboardSlice";
        ...
        <View style={[appStyles.sreenView, { backgroundColor: colors.background }]}>
            <View style={{ paddingVertical: 10, paddingHorizontal: 20, flex: 1 }}>
                <View style={homeStyles.textView}>
                    ...
                    <AppTextBold styles={{ padding: 4 }} text="✦"></AppTextBold>
                </View>
                ...
                <View style={homeStyles.rowStylesText}>
                    ...
                    <Pressable style={homeStyles.textOverColor} onPress={() => { navigation.navigate('FavouritesScreen') }}>
                        <AppTextSmall text={AppStrings.viewFav} />
                    </Pressable>
                    <View />
                </View>
                <FlatList
